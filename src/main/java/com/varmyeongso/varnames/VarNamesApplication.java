package com.varmyeongso.varnames;
...
public class VarNamesApplication {

    public static void main(String[] args) {
        final ConfigurableApplicationContext ctx = SpringApplication.run(VarNamesApplication.class, args);
        final MockData mockData = ctx.getBean(MockData.class);
        mockData.createCodes(10);
    }
...
class MockData {
    ...
    public void createCodes(int count) {
